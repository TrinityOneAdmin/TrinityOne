      ...
      <div style={card}>
        ...
        {mode === 'choose' ? (
          ...
          <div>
            ...
            <input type="password" value={pinVal} onChange={e => { setPinVal(e.target.value); setErr(''); }} autoFocus placeholder="At least 8 — a generated password is best" onKeyDown={e => { if (e.key === 'Enter' && pinVal.length >= 8 && !pinBusy) finishWithPin(); }} style={{ width: '100%', boxSizing: 'border-box', border: '1px solid var(--line)', borderRadius: 12, background: 'var(--surface-2)', padding: '12px 14px', fontSize: 15, fontFamily: 'var(--font-ui)', color: 'var(--ink)', outline: 'none', letterSpacing: '2px' }} />
