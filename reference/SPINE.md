...
*Still to decide:* whether the recipient's identity is shown to slot-fillers ("Bring meal Tuesday for Sarah Jones") or anonymised ("for a family in our church") — likely also a steward setting that defaults to the recipient's own preference. Cousin to Manna ([`MANNA-MODULE.md`](../MANNA-MODULE.md), being scoped) but distinctly **non-financial** — meals not money.
