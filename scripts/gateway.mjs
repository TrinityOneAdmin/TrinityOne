...
const GROUP_D = 'trinityone/group:', FUND_D = 'trinityone/fund:', MEMBER_D = 'trinityone/member:';
...
function accept(e) {
  ...
  if (k === 30078) {
    const d = dtag(e);
    if (d.startsWith(GROUP_D) || d.startsWith(FUND_D)) return isChurch;   // church definitions only
